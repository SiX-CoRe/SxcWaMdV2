...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        let apiUrl = `${global.web}/api/tools/8upload?apikey=${apiKey}`;
...
handler.help = ["8upload (reply media)"];
