...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        let apiUrl = `${global.web}/api/tools/pone-uploader?apikey=${apiKey}`;
...
handler.help = ["poneuploader (reply media)"];
handler.command = ["poneuploader","pone"];
handler.tags = ['tools'];
