...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        let apiUrl = `${global.web}/api/tools/aceimg?apikey=${apiKey}`;
...
handler.help = ["aceimg (reply media)"];
