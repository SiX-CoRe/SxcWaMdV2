...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        let apiUrl = `${global.web}/api/tools/upload-zass?apikey=${apiKey}`;
...
handler.help = ["uploadzass (reply media)"];
handler.command = ["uploadzass","zass"];
handler.tags = ['tools'];
