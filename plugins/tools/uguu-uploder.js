...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    try {
        ...
        let apiUrl = `${global.web}/api/tools/uguu-uploder?apikey=${apiKey}`;
...
handler.help = ["uguuuploader (reply media)"];
handler.command = ["uguuuploader","uguu"];
handler.tags = ['tools'];
