...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    ...
    try {
        ...
        let url = `${global.web}/api/maker/igqc?apikey=${global.apikey.jereapi}&txt=${encodeURIComponent(txt)}&imgUrl=${encodeURIComponent(imgUrl)}&menuTimeStr=${encodeURIComponent(timeNow)}`
